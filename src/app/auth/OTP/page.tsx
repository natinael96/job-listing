    ...
    return (
        <>
            <div className="flex items-center justify-center min-h-screen bg-white p-2">
                <div className="flex flex-col gap-4 w-3/5 lg:w-96 p-10 bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <form>
                        <div className="mb-4">
                            ...
                            <div className="mb-4 text-center">
                                You can request to 
                                <button className="text-blue-800 font-extrabold" onClick={handleResend} disabled={!resendEnabled}>
                                    Resend
                                </button> 
                                in
                                <div className="text-blue-800 font-extrabold">{`0:${timer < 10 ? `0${timer}` : timer}`}</div>
                            </div>
                            <button className="w-full bg-[#1b1787] text-white font-bold py-2 px-4 rounded-3xl hover:bg-[#6E62E5] focus:outline-none focus:shadow-outline" type="submit" onClick={handleSubmit}>
                                Continue
                            </button>
                        </div>
                    </form>
